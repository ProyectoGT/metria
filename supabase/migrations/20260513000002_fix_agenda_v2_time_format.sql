-- ─── Fix: formato de hora sin segundos al llamar a upsert_agenda_reminders ────
--
-- Problema:
--   En create_agenda_activity_v2, p_time es time without time zone.
--   Al hacer p_time::text, PostgreSQL incluye segundos: "09:44:00".
--   calc_reminder_scheduled_at espera "HH:MM" y añade ":00",
--   resultando en "09:44:00:00" → error de parseo de timestamp.
--
--   Error: invalid input syntax for type timestamp: "2026-05-08 09:44:00:00"
--
-- Solucion: usar to_char(p_time, 'HH24:MI') en lugar de p_time::text.
...
begin
  ...
  -- Registrar recordatorio si aplica (formato HH:MM sin segundos)
...
comment on function public.create_agenda_activity_v2 is
  'Crea actividad en agenda (v2). Fix: to_char(p_time, HH24:MI) para upsert_agenda_reminders.';
