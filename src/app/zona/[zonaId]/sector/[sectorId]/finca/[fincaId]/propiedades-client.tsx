...
const ESTADOS = [
  ...
  { value: "investigacion", label: "Investigación", classes: "bg-blue-100 text-blue-700" },
  { value: "seguimiento", label: "Seguimiento", classes: "bg-amber-100 text-amber-700" },
        ...
        <div className="overflow-hidden rounded-xl border border-border bg-surface shadow-sm">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-border">
              {propiedades.map((p) => {
                const overdue = isOverdue(p.fecha_visita);
                return (
                  <tr key={p.id} className="transition-colors hover:bg-background">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex items-center gap-1.5">
                        {overdue && (
                          <span
                            title="Han pasado más de 90 días desde la última visita"
                        ...
                        <span className={overdue ? "text-amber-600 font-medium" : "text-text-secondary"}>
                          {p.fecha_visita
