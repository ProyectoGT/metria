export default function OfflinePage() {
  return (
    <html lang="es">
      <body style={{ margin: 0, padding: 0, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", backgroundColor: "#f4f4f5", display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh" }}>
        <div style={{ textAlign: "center", padding: "40px 24px", maxWidth: 400 }}>
          ...
          <button
            ...
            style={{ display: "inline-block", backgroundColor: "#2563eb", color: "#fff", fontSize: 15, fontWeight: 600, padding: "13px 28px", borderRadius: 8, border: "none", cursor: "pointer" }}
          >
            Reintentar
          </button>
