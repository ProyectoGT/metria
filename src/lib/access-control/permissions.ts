...
const PERMISSIONS: Partial<Record<Module, Partial<Record<Action, PermissionRule>>>> = {
  ...
  calendario: {
    view: { roles: EVERYONE },
    create: { roles: SUPPORT_ROLES },
    update: { roles: SUPPORT_ROLES, entityScope: "own" },
  ...
  tareas: {
    ...
    update: { roles: SUPPORT_ROLES, entityScope: "own" },
    delete: { roles: SUPERVISOR_ROLES },
    complete: { roles: SUPPORT_ROLES, entityScope: "own" },
  ...
  contactos: {
    view: { roles: EVERYONE },
    create: { roles: SUPPORT_ROLES },
    update: { roles: SUPPORT_ROLES },
    delete: { roles: COMMERCIAL_ROLES },
    export: { roles: MANAGER_ROLES },
  },
  usuarios: {
